...
export const preachingPresentations: Presentation[] = [
  {
    ...
    introduction: {
      ...
      kea: 'Txeu pésoa ta ora "Ben bu Réinu" mas es ka sabe ezatamenti kuze ki é Réinu di Deus. Bíblia ta djuda-nu komprende kuze ki é es Réinu y kuze ki el ta faze.',
    ...
    question: {
      ...
      kea: 'Kuze ki es téstu ta ensina-nu sobri Reinu di Deus?',
    ...
    explanation: {
      ...
      kea: 'Reinu di Deus é un governu real stabelesidu pa Deus na séu. El ta substitui tudu governus umanu y traze paz y seguransa eternu pa Terra.',
    ...
    conclusion: {
      ...
      kea: 'En brevi, Reinu di Deus ta transforma Terra nun paraízu, undi tudu pesoas ta vive na paz y armonia.',
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Bíblia é livru más traduzidu y distribuídu di mundu. El ten mensaji di Deus pa umanidadi.'
    },
    scripture: {
    ...
    question: {
      ...
      kea: 'Di ki manera Bíblia pode djuda-nu?'
    },
    explanation: {
      pt: 'A Bíblia nos ajuda a conhecer a Deus, a entender seu propósito para nós e a viver uma vida que o agrade.',
      kea: 'Bíblia ta djuda-nu konxe Deus, entendi si propózitu pa nós y vive un vida ki ta agrada-L.'
    },
    conclusion: {
      pt: 'Estudar a Bíblia regularmente pode nos ajudar a encontrar respostas para as questões mais importantes da vida.',
      kea: 'Studa Bíblia regularmenti pode djuda-nu atxa resposta pa kestons más importanti di vida.'
    },
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Jesus Kristu é pesoa más importanti ki dja vive na Terra. Konxe-l pode muda nos vida pa sempri.'
    },
    scripture: {
      reference: 'João 3:16',
      text: {
    ...
    question: {
      ...
      kea: 'Kuze ki es téstu ta ensina-nu sobri Jesus?'
    },
    explanation: {
      pt: 'Jesus é o Filho de Deus, enviado à Terra por amor à humanidade. Ele deu sua vida para que possamos ter vida eterna.',
      kea: 'Jesus é Fidju di Deus, enviadu pa Terra pa amor a umanidadi. El da si vida pa ki nu pode ten vida eternu.'
    },
    conclusion: {
      pt: 'Conhecer a Jesus e exercer fé nele é o caminho para a vida eterna.',
      kea: 'Konxe Jesus y izerse fé n-El é kaminhu pa vida eternu.'
    },
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Família é un dádiva di Deus. Bíblia ten prinsípius ki pode djuda famílias ser feliz.'
    },
    scripture: {
    ...
    question: {
      ...
      kea: 'Ki prinsípius bíbliku pode fortifika família?'
    },
    explanation: {
      ...
      kea: 'Amor y respetu mútuus é esensial pa felisidadi familiar. Kantu kada membru di família ta sigi prinsípius bíbliku, lar ta torna un lugar di paz y alegria.'
    },
    conclusion: {
      pt: 'Aplicar os princípios bíblicos pode ajudar sua família a ser mais feliz.',
      kea: 'Aplika prinsípius bíbliku pode djuda bu família ser más feliz.'
    },
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Morti é algu ki ta afeta tudu nós. Bíblia ta da-nu un speransa rekonfortanti pa kes ki more.'
    },
    scripture: {
    ...
    question: {
      ...
      kea: 'Ki speransa Bíblia ta oferese pa mortu?'
    },
    explanation: {
      ...
      kea: 'Bíblia ta ensina ma Deus ta resusita mortu pa vive nun Terra paradizíaka. Keli é un promesa seguru ki ta da-nu konfortu y speransa.'
    },
    conclusion: {
      pt: 'Em breve, Deus cumprirá sua promessa de ressurreição, reunindo famílias e amigos.',
      kea: 'En brevi, Deus ta kumpri si promesa di resureison, reunindu famílias y amigus.'
    },
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Nun mundu xeiu di ansiedadi y stresi, txeu ta buska paz interior. Bíblia ta mostra modi ki ta atxa-l.'
    },
    scripture: {
    ...
    question: {
      ...
      kea: 'Modi ki nu pode atxa verdaderu paz interior?'
    },
    explanation: {
      ...
      kea: 'Verdaderu paz ta ben di konfia na Deus y sigi si orientason. Orason y meditason na Palavra di Deus ta djuda-nu ten paz interior.'
    },
    conclusion: {
      pt: 'Ao aplicar os conselhos bíblicos, podemos encontrar paz duradoura mesmo em tempos difíceis.',
      kea: 'Kantu nu ta aplika konselhu bíbliku, nu pode atxa paz duradoru mesmu na tempus difísil.'
    },
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Sufrimentu ta afeta pesoas na tudu mundu. Bíblia ta splika pamodi ki sufrimentu ta izisti y modi ki el ta kaba.'
    },
    scripture: {
    ...
    question: {
      ...
      kea: 'Kuze ki Deus ta promete faze ku sufrimentu?'
    },
    explanation: {
      ...
      kea: 'Deus ta promete elimina tudu sufrimentu y ses kausas. El ta uza si Reinu pa traze paz y felisidadi duradoru pa Terra.'
    },
    conclusion: {
      pt: 'Podemos ter certeza de que Deus cumprirá sua promessa de acabar com todo sofrimento.',
      kea: 'Nu pode ten serteza ma Deus ta kumpri si promesa di kaba ku tudu sufrimentu.'
    },
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Txeu ta dizeja aproxima di Deus mas ka sabe modi. Bíblia ta mostra-nu kaminhu.'
    },
    scripture: {
      reference: 'Tiago 4:8',
      text: {
    ...
    question: {
      ...
      kea: 'Modi ki nu pode aproxima di Deus?'
    },
    explanation: {
      pt: 'Nos aproximamos de Deus através da oração sincera, do estudo da Bíblia e da aplicação de seus princípios em nossa vida.',
      kea: 'Nu ta aproxima di Deus através di orason sinseru, studu di Bíblia y aplikason di si prinsípius na nos vida.'
    },
    conclusion: {
      pt: 'Deus quer que nos aproximemos dele e promete nos ajudar nesse processo.',
      kea: 'Deus kre pa nu aproxima d-El y ta promete djuda-nu nes procesu.'
    },
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Txeu pesoas ta pergunta kal ki é propózitu di vida. Bíblia ta djuda-nu atxa un verdaderu sentidu pa vida.'
    },
    scripture: {
    ...
    question: {
      ...
      kea: 'Modi ki nu pode atxa verdaderu propózitu na vida?'
    },
    explanation: {
      ...
      kea: 'Nu ta atxa verdaderu propózitu kantu nu konxe Deus y vive di akordu ku si padrons. Kel-li ta traze satisfason duradoru.'
    },
    conclusion: {
      pt: 'Viver de acordo com o propósito de Deus traz verdadeira felicidade e satisfação.',
      kea: 'Vive di akordu ku propózitu di Deus ta traze verdaderu felisidadi y satisfason.'
    },
  ...
  },
  {
    ...
    introduction: {
      ...
      kea: 'Ten un bon relason ku Deus é más importanti na vida. Bíblia ta mostra-nu modi ki dizevolve es relason.'
    },
    scripture: {
    ...
    question: {
      ...
      kea: 'Modi ki nu pode dizevolve un bon relason ku Deus?'
    },
    explanation: {
      pt: 'Desenvolvemos uma boa relação com Deus através da oração regular, do estudo da Bíblia e da aplicação do que aprendemos.',
      kea: 'Nu ta dizevolve un bon relason ku Deus através di orason regular, studu di Bíblia y aplikason di kuze ki nu ta prendi.'
    },
    conclusion: {
      pt: 'Quando nos esforçamos para conhecer a Deus, ele nos ajuda a desenvolver uma relação próxima com ele.',
      kea: 'Kantu nu ta sforsa pa konxe Deus, el ta djuda-nu dizevolve un relason prósimu ku El.'
    },
