...
export const grammarLessons: GrammarLesson[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      {
        pt: 'Ela cantou - El kanta / El dja kanta',
        cv: 'Ela cantou - El kanta / El dja kanta'
      },
      {
      ...
      {
        pt: 'Eles andaram - Es anda / Es dja anda',
        cv: 'Eles andaram - Es anda / Es dja anda'
      },
      {
        pt: 'Eu vi - N odja / N dja odja',
        cv: 'Eu vi - N odja / N dja odja'
      },
      {
        pt: 'Tu ouviste - Bu obi / Bu dja obi',
        cv: 'Tu ouviste - Bu obi / Bu dja obi'
      },
      {
        pt: 'Ela sentiu - El sinti / El dja sinti',
        cv: 'Ela sentiu - El sinti / El dja sinti'
      },
      {
      ...
      {
        pt: 'Eles deram - Es da / Es dja da',
        cv: 'Eles deram - Es da / Es dja da'
      }
    ]
  },
  {
    ...
    examples: [
      ...
      {
        pt: 'Eu vou dever - N ta deve / N ta ba deve / N al deve',
        cv: 'Eu vou dever - N ta deve / N ta ba deve / N al deve'
      },
      {
        pt: 'Tu vais ir - Bu ta ba / Bu ta ba ba / Bu al ba',
        cv: 'Tu vais ir - Bu ta ba / Bu ta ba ba / Bu al ba'
      },
      {
        pt: 'Ela vai vir - El ta ben / El ta ba ben / El al ben',
        cv: 'Ela vai vir - El ta ben / El ta ba ben / El al ben'
      },
      {
        pt: 'Nós vamos fazer - Nu ta faze / Nu ta ba faze / Nu al faze',
        cv: 'Nós vamos fazer - Nu ta faze / Nu ta ba faze / Nu al faze'
      },
      {
        pt: 'Vocês vão dizer - Nhos ta fla / Nhos ta ba fla / Nhos al fla',
        cv: 'Vocês vão dizer - Nhos ta fla / Nhos ta ba fla / Nhos al fla'
      },
      {
        pt: 'Eles vão dar - Es ta da / Es ta ba da / Es al da',
        cv: 'Eles vão dar - Es ta da / Es ta ba da / Es al da'
      }
    ]
  },
  {
    ...
    examples: [
      ...
      {
        pt: 'Ela não sente - El ka ta sinti',
        cv: 'Ela não sente - El ka ta sinti'
      },
      {
...
export const dictionaryEntries: DictionaryEntry[] = [
  ...
  },
  {
    ...
    example: {
      ...
      cv: 'Sabiduria ta txoma na rua, na caminhu di sabidoria tem vida.'
    }
  },
  {
    id: 'entry-1038',
